...
require (
	...
	github.com/go-acme/lego/v3 v3.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/go-acme/lego/v3 => github.com/akillcool/lego/v3 v3.5.1-0.20200318162146-d91703d4c98b
